    ...
    <div id="contact">
      <div class="container">
		...
		<div class="col-md-4 col-md-offset-4 text-center">
		  ...
		  <!-- contact form starts -->
            <form method="POST" action="registroSms.php" id="contact-form" class="form-horizontal">
			<fieldset>
			...
			<div class="form-group">
						      ...
						      <div class="col-sm-8">
						        <textarea placeholder="Aqui el numero" class="form-control" name="tele1" id="tele1" rows="1"></textarea>
						      </div>
		      </div>			   
						    ...
						    <div class="form-group">
						      <label class="col-sm-4 control-label" for="message">Mensaje</label>
						      <div class="col-sm-8">
						        <textarea placeholder="Aquí el mensaje" class="form-control" name="texto" id="texto" rows="5"></textarea>
						      </div>
						    </div>
