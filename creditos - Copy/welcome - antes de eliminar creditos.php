...
s"><i class="service-icon fa fa-envelope"></i>&nbsp;Registro de abonos</a></li>
  ...
  <!-- Credito -->
    ...
    <div class="col-md-4 col-md-offset-4 text-center">
      ...
      <fieldset>
                ...
                <div class="form-group">
                  <label class="col-sm-4 control-label" for="subject">Cantidad de credito</label>
                  <div class="col-sm-8">
                    <input type="number" placeholder="Digite la cantidad del credito" class="form-control" name="credito" id="credito">
                  </div>
                </div>
...
<label class="col-sm-4 control-label" for="message">Cuota</label>
                  <div class="col-sm-8">
                   <input type="number" placeholder="Cuota" class="form-control" name="cuotaCredito" id="cuotaCredito" required >
                  </div>
                </div>
