...
$comentarios= ($_POST["observacionCierre"]);



caja($efectivoEnCaja,$apartadoEnCaja,$gastosEfectivo,$ventasEfectivo,$montoInicial, $comentarios, $montoAtrasadoSemanal,$montoAtrasadoQuincenal,$montoAtrasadoMensual  );
...
function caja ($efectivoEnCaja,$apartadoEnCaja,$gastosEfectivo,$ventasEfectivo,$montoInicial, $comentarios, $montoAtrasadoSemanal,$montoAtrasadoQuincenal,$montoAtrasadoMensual  )
{
