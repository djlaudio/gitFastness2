...
<li><a href="#anulacioncuota"><i class="service-icon fa fa-envelope"></i>&nbsp;Anulacion de cuota</a></li>
...
<script>
  ...
  <!-- Anulacion de creditos -->
    <div id="anulacioncuota">
      <div class="container">
        <div class="row">
		<div class="col-md-4 col-md-offset-4 text-center">
            <h2>Anulacion Cuota</h2>
			<hr>
          </div>
          <div class="col-md-5 col-md-offset-3">
		  <!-- contact form starts -->
            <form method="POST" action="functionAnularCredito.php" id="contact-form" class="form-horizontal">
			<fieldset>
...
data: {
       idCredito:$(#selComboCreditos2).val();
     },
     success: function (response) {
