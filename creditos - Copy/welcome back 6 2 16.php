...
<?php include('connect_db.php');
								$query = mysqli_query($link,"SELECT diaPago, idCredito, idClienteCredito, credito.codigoProducto, descrProducto, CONCAT( d.DescrDia,  ': ', cantidadCredito, ' col ') AS descripcion
FROM dia d
