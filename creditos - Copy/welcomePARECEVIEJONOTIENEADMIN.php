    ...
    <div id="clients">
      <div class="container">
		...
		<div class="col-md-4 col-md-offset-4 text-center">
		  ...
		  <!-- contact form starts -->
            <form action="registro.php" id="contact-form" class="form-horizontal">
			<fieldset>
...
<div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <input type="number" value="####-##-##" placeholder="Cedula" class="form-control" name="cédula" id="cédula" >
						      </div>
						   </div>
 ...
 <div class="form-group">
						 ...
						 <div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <input type="text"  placeholder="Nombre Completo" class="form-control" name="nombreCliente" id="nombreCleinte" required>
						   </div>
						 </div>
						 <div class="form-group">
						      <label class="col-sm-4 control-label" for="name">Telefono</label>
						      <div class="col-sm-8">
						       <input type="number" value="####-##-##" placeholder="Telefono" class="form-control" name="telefono" id="telefono" >
						      </div>
						   </div>
 ...
 <div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <input type="number" value="####-##-##" placeholder="Telefono2" class="form-control" name="telefono" id="telefono" >
						      </div>
						   </div>
						  ...
						  <div class="form-group">
						      <label class="col-sm-4 control-label" for="fecha">Fecha Ingreso</label>
						      <div class="col-sm-8">
						      <input type="datetime-local" name="fechaingreso" step="1" min="2015-11-11T00:00" max="2020-12-31T12:00" value="2015-11-11T12:00">    </div>
						    </div>
    ...
    <label class="col-sm-4 control-label" for="name">Calificación</label>
						      <div class="col-sm-8">
						       <SELECT NAME="selCombo" SIZE=1 > 
								<OPTION VALUE="link pagina 1">EXCELENTE</OPTION>
								<OPTION VALUE="link pagina 2">BUENO</OPTION>
								<OPTION VALUE="link pagina 3">MALO</OPTION>
								<OPTION VALUE="link pagina 4">DEUDOR</OPTION> 
		...
		<div class="col-md-4 col-md-offset-4 text-center">
		  ...
		  <!-- contact form starts -->
			...
			<fieldset>
						    <div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <SELECT NAME="selCombo" SIZE=1 > 
								...
								<option value=" <?php echo $row['idCliente'] ?> "><?php echo $row['idPersona']; ?></option>
								<?php } ?>
						    ...
						    <div class="form-group">
						      <label class="col-sm-4 control-label" for="email">Monto Actual</label>
						      <div class="col-sm-8">
						        <input type="text" text="15000" placeholder="Monto Actual" class="form-control" name="montoActual" id="montoActual" disabled>
						      </div>
						    </div>
							  <div class="form-group">
...
<OPTION VALUE="6">SÁBADO</OPTION> 
							...
							<div class="form-group">
						      <label class="col-sm-4 control-label" for="fecha">Fecha Abono</label>
						      <div class="col-sm-8">
						      <input type="datetime-local" name="fechahora" step="1" min="2015-11-11T00:00" max="2020-12-31T12:00" value="2015-11-11T12:00">    </div> 
							 </div>
						    </div>
						    <div class="form-group">
    ...
    <div id="contact">
      <div class="container">
		...
		<div class="col-md-4 col-md-offset-4 text-center">
          ...
          <div class="col-md-5 col-md-offset-3">
		  <!-- contact form starts -->
            <form method="POST" action="registro.php" id="contact-form" class="form-horizontal">
			<fieldset>
						    <div class="form-group">
						      <label class="col-sm-4 control-label" for="name">Cliente</label>
						      <div class="col-sm-8">
						         <SELECT NAME="selCombo" SIZE=1 required> 
							   	<?php include('connect_db.php');
								$query = mysqli_query($link,"select idCredito, idClienteCredito, codigoProducto, descrProducto,  from credito where saldoActual>0");
								while($row = mysqli_fetch_assoc($query)){?>
...
<div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <SELECT NAME="selCombo" SIZE=1 > 
								<OPTION VALUE="link pagina 1">LUNES</OPTION>
								<OPTION VALUE="link pagina 2">MARTES</OPTION>
								<OPTION VALUE="link pagina 3">MIERCOLES</OPTION>
								<OPTION VALUE="link pagina 4">JUEVES</OPTION> 
<OPTION VALUE="link pagina 4">VIERNES</OPTION> 
<OPTION VALUE="link pagina 4">SÁBADO</OPTION> 
								</SELECT> 
						      </div>
						    </div>
