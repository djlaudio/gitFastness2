...
$section1->addText("ABONOS",array("size"=>12,"bold"=>true,"align"=>"right"));
...
$table1->addRow();
$table1->addCell(50)->addText($abono->idAbono);
$table1->addCell(500)->addText($abono->fechaAbono);
$table1->addCell(200)->addText($abono->cantidadAbono);
$table1->addCell(200)->addText($abono->saldoCredito);
$table1->addCell(200)->addText($abono->observacion);
$table1->addCell(200)->addText($abono->diaPago);
$table1->addCell(200)->addText($abono->idCredito);
$table1->addCell(200)->addText($abono->porcComisionCobrador);
$table1->addCell(200)->addText($abono->idCobrador);
