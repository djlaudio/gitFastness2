    ...
    <div id="wrapper">
      ...
      <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
        ...
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="./">FASTNESS CLOTHING <sup><small><span class="label label-primary">v2.0</span></small></sup> </a>
        </div>
...
?>
          ...
          <li><a href="index.php?view=box"><i class="fa fa-archive"></i> Caja</a></li>
		   <li><a href="creditos/welcome.php#abonos"><i class="service-icon fa fa-envelope"></i>&nbsp;Registro de creditos</a></li>
...
if( isset($_SESSION["user_id"]) && $_SESSION["user_id"]!=""){
  ...
  $user = $u->name." ".$u->lastname;
   ...
   <li class="dropdown user-dropdown">
        ...
        <b>FASTNESS CLOTHING </b><b class="caret"></b>
        </a>
        <ul class="dropdown-menu">
          <li><a href="http://fastnessclothing.com/">Ver sitio</a></li>
          <li><a href="http://fastnessclothing.com/">Comprar Marcas Genuinas</a></li>
          <li><a href="http://fastnessclothing.com/">Soporte</a></li>
        </ul>
        </li>
            <li class="dropdown user-dropdown">
        <a href="#" class="dropdown-toggle" data-toggle="dropdown">
