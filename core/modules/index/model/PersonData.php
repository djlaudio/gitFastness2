...
// partiendo de que ya tenemos creado un objecto PersonData previamente utilizamos el contexto
	...
	public function update_client(){
		$sql = "update ".self::$tablename." set name=\"$this->name\",email1=\"$this->email1\",address1=\"$this->address1\",lastname=\"$this->lastname\",phone1=\"$this->phone1\",nameBusiness=\"$this->nameBusiness\",cedula=\"$this->cedula\" where id=$this->id";
		Executor::doit($sql);
	}
...
$data->nameBusiness = $r['nameBusiness'];
			$found = $data;
			break;
		}
		return $found;
