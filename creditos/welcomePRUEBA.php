...
<div class="form-group">
						      <label class="col-sm-4 control-label" for="name">Dia de pago</label>
						      <div class="col-sm-8">
<?php $idTipoClientes=$_SESSION['idTipoClientes'];?>
...
WHERE credito.diapago=$dayNum and credito.idTipoClientes=$idTipoClientes
order by credito.diaPago, credito.idCredito");
                ...
                -->                
                <SELECT id="divDatosCLiente" NAME="divDatosCLiente" SIZE=1  
                     onchange="load_Client_Information(this.value);" required> 
                </SELECT>               
...
<div class="form-group">
						      ...
						      <div class="col-sm-8">
						       <SELECT id="selComboSigDiaPago" NAME="selComboSigDiaPago"  SIZE=1 > 
								<OPTION VALUE="1">LUNES</OPTION>
								<OPTION VALUE="2">MARTES</OPTION>
								<OPTION VALUE="3">MIERCOLES</OPTION>
								<OPTION VALUE="4">JUEVES</OPTION> 
