...
if($_POST)
	...
	$sql="INSERT INTO abono(idCreditoAbono, cantidadAbono, diaPago, tipo_pago, observacion, fechaAbono, idCobrador, saldoCredito, porcComisionCobrador) values ('$idCredito','$abono','$diaPago','$tipoPago','$message','$fechaAbono','$idUsuario','$saldoDespuesDeAbono','0' )" ;
