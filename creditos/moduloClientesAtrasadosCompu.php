...
<!-- /Actualizacion de datos -->
  ...
  <!-- Actualizacion de datos semanales -->
    <div id="semana1">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Clientes atrasados semanales</h2>
      <hr>
          </div>
...
<th width=30>Credito</th>
<th width=200>Nombre</th>
<th width=200>tel</th>
<th width=200>tel</th>
<th width=40>Monto Credito</th>
<th width=40>Monto pagado</th>
<th width=40>Atraso</th>
<th width=40>Cuota</th>
<th width=40>Cuotas atrasadas</th>
</tr>
...
<tr>
<td class='text-center'><?php echo $row['fechaCredito'] ?></td>
<td class='text-center'><?php echo $row['idCredito'] ?>
...
<td class='text-center'><?php echo $row['cantidadCredito'] ?></td>
<td class='text-center'><?php echo $row['montoPagado']; ?></td>
<td class='text-center'><?php echo montoAtrasadoDeCredito(intval($row['cantidadCredito']), intval($row['diferencia']), intval($row['montoPagado'])) ; ?></td>
<? $totalDiferencia+= montoAtrasadoDeCredito(intval($row['cantidadCredito']), intval($row['diferencia']), intval($row['montoPagado'])) ; ?>
<td class='text-center'><?php echo $row['cuotaCredito']; ?></td>
<td class='text-center'><?php echo intval($row['cuotasAtrasadas']); ?></td>
...
$totalCantidadCredito+=$row['cantidadCredito'];
$totalMontoPagado+=$row['montoPagado'];

$totalCuotasAtrasadas+=intval($row['cuotasAtrasadas']);
...
<tr>
<td class='text-center'><?php echo 'TOTALES' ?></td>
...
<td class='text-center'><?php echo $totalCantidadCredito; ?></td>
<td class='text-center'><?php echo $totalMontoPagado; ?></td>
<td class='text-center'><?php echo $totalDiferencia; ?></td>
<td class='text-center'><?php echo $row['cuotaCredito']; ?></td>
<td class='text-center'><?php echo $totalCuotasAtrasadas; ?></td>
...
?>
 ...
 <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnVerMasivo" class="btn btn-primary">Ver Mensajes a enviar</button>
              </div>   
            </fieldset>     

            <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnEnviarMasivo" class="btn btn-primary">Enviar Masivo</button>
              </div>   
            </fieldset>         
  ...
  <!-- Actualizacion de datos quincenales -->
    <div id="contact">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Clientes atrasados quincenales</h2>
      <hr>
          </div>
          <div class="col-md-5 col-md-offset-3">
      <!-- contact form starts -->
...
<fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnVerMasivo2" class="btn btn-primary">Ver mensajes a enviar</button>
              </div>   
            </fieldset>  

            <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnEnviarMasivo2" class="btn btn-primary">Enviar Masivo</button>
              </div>   
            </fieldset>         
  ...
  <!-- Actualizacion de datos mensuales -->
    <div id="contact">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Clientes atrasados mensuales</h2>
      <hr>
          </div>
          <div class="col-md-5 col-md-offset-3">
      <!-- contact form starts -->
...
<tr>
<td class='text-center' width="500" > <?php echo $row['fechaCredito'] ?></td>
<td class='text-center'><?php echo $row['idCredito'] ?>
<td class='text-center'><?php echo $row['numFactura'] ?></td>
<td class='text-center'><?php echo $row['name']; ?></td>
<td class='text-center'><?php echo $row['phone1']; ?></td>
...
?>
 ...
 <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnVerMasivo3" class="btn btn-primary">Ver mensajes a enviar</button>
              </div>   
            </fieldset>     

            <fieldset>
              <div class="col-sm-offset-4 col-sm-8">
                <button type="submit" id="btnEnviarMasivo3" class="btn btn-primary">Enviar Masivo</button>
              </div>   
            </fieldset>         
  ...
  <!-- Actualizacion de datos toooodos -->
    <div id="contact">
      <div class="container">
        <div class="row">
    <div class="col-md-4 col-md-offset-4 text-center">
            <h2>Clientes de creditos</h2>
      <hr>
          </div>
          <div class="col-md-5 col-md-offset-3">
      <!-- contact form starts -->
...
<th width=40>Monto pagado</th>
<th width=40>Cuota</th>
<th width=40>Termino de pago</th>
</tr>
...
<td class='text-center'><?php echo intval($row['termino_id']); ?></td>
<td class='text-center'><?php echo montoAtrasadoDeCredito(intval($row['cantidadCredito']), intval($row['diferencia']), intval($row['montoPagado'])) ; ?></td>
<? $totalDiferencia+= montoAtrasadoDeCredito(intval($row['cantidadCredito']), intval($row['diferencia']), intval($row['montoPagado'])) ; ?>
<td class='text-center'><?php echo intval($row['diferenciaEnDb']); ?></td>
</tr>
...
<script type="text/javascript">
 ...
 <script type="text/javascript">
  $( "#btnVerMasivo" ).click(function() {
    
    $.ajax({
     type: 'post',
     url: 'functionVerSms.php',
     success: function (response) {
       alert(response);
     }
   });
...
<script type="text/javascript">
  $( "#btnVerMasivo2" ).click(function() {
    
    $.ajax({
     type: 'post',
     url: 'functionVerSms2.php',
     success: function (response) {
       alert(response);
     }
   });
...
<script type="text/javascript">
  $( "#btnVerMasivo3" ).click(function() {
    
    $.ajax({
     type: 'post',
     url: 'functionVerSms3.php',
     success: function (response) {
       alert(response);
     }
   });
